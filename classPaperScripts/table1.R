...
demo.vals.male <- summarySE(data=male.data, measurevar="ageAtScan1", groupvars="dosage")
demo.vals.female <- summarySE(data=female.data, measurevar="ageAtScan1", groupvars="dosage")
...
sex <- rep('Male', 7)
demo.vals.male <- rbind(demo.vals.male, summarySE(data=male.data, measurevar="ageAtScan1", groupvars="dosage")[c(5,6),])
demo.vals.male <- cbind(sex, demo.vals.male)
sex <- rep('Female', 7)
demo.vals.female <- rbind(demo.vals.female, summarySE(data=female.data, measurevar="ageAtScan1", groupvars="dosage")[c(5,6),])
